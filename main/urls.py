...
urlpatterns = [
    ...
    path('profile/<int:pk>/imageposts', views.ProfilePostList.as_view(), name="profile_posts"),
    path('profile/<int:pk>/draftposts', views.ProfileDrafts.as_view(), name="profile_drafts"),
